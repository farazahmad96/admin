 ...
 <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav md:block lg:block">
     ...
     <ul class="list-reset flex flex-col">
         <li class=" w-full h-full py-3 px-2 border-b border-light-border <?= $dashboardActive ?>">
         ...
         <li class="w-full h-full py-3 px-2 border-b border-light-border <?= $businessActive ?>">
             <a href="businesses.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                 <i class="fa fa-building float-left mx-2"></i>
                 Businesses
                 <span><i class="fa fa-angle-right float-right"></i></span>
             </a>
         </li>
         <li class="w-full h-full py-3 px-2 border-b border-light-border <?= $categoriesActive ?>">
             <a href="category.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                 <i class="fa fa-folder float-left mx-2"></i>
                 Categories
                 <span><i class="fa fa-angle-right float-right"></i></span>
             </a>
         </li>
         <li class="w-full h-full py-3 px-2 border-b border-light-border <?= $couponsActive ?>">
             <a href="coupons.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                 <i class="fa fa-folder float-left mx-2"></i>
                 Coupons
                 <span><i class="fa fa-angle-right float-right"></i></span>
             </a>
         ...
         <li class="w-full h-full py-3 px-2 hidden">
